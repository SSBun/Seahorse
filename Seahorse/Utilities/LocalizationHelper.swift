...
struct L10n {
    ...
    static let startup = NSLocalizedString("Startup", comment: "Startup settings section title")
    static let launchAtLogin = NSLocalizedString("Launch at Login", comment: "Startup launch at login toggle")
    static let launchAtLoginHint = NSLocalizedString("Automatically start Seahorse when you log in to macOS", comment: "Startup launch at login hint")
